...
openai.api_key = "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"
...
class GoogleChat():
    def __init__(self):
        ...
        self.service = build(
            ...
            "customsearch", "v1", developerKey="AIzaSyAZvPEKmK2qPK6TVaP9-tqOi3GpTAFanFU"
        )
    ...
    def _search(self, query):
        ...
        response = (
            ...
            .list(
                ...
                cx="e3a2db6e7281d4629", # https://programmablesearchengine.google.com/controlpanel/all
            )
            .execute()
        )
...
if __name__ == '__main__':
    ...
    with gr.Blocks(css="#chatbot .overflow-y-auto{height:500px}") as demo:
        chatbot = gr.Chatbot([], elem_id="chatbot", label="GPT-4 Bing Clone")
        with gr.Row():
            with gr.Column(scale=0.85):
                txt = gr.Textbox(show_label=False, placeholder="What do you want to know?",container=False)
